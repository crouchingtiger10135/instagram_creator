            ...
            <div class="bg-white overflow-hidden shadow rounded-lg p-6">
                ...
                >
                    ...
                    <div id="crop-container" class="mb-4 hidden">
                        ...
                        <div class="w-full">
                            <!-- Use the same image as the current image -->
    ...
    @push('scripts')
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                // When "Crop Current Image" is clicked, initialize Cropper.js on the displayed current image.
                cropCurrentBtn.addEventListener('click', function() {
                    // Show the crop container if not already visible.
                    cropContainer.classList.remove('hidden');
                    // Initialize Cropper.js on the cropper image.
                    if (cropper) {
                        cropper.destroy();
                    }
                    cropper = new Cropper(cropperImage, {
                        aspectRatio: 4 / 5,  // enforce 4:5 ratio
                        viewMode: 1,
                    });
                });

                // When "Apply Crop" is clicked, capture crop data and store in hidden inputs.
